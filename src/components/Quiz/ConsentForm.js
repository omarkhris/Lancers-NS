...
export const ConsentForm = () => (
    <Fragment>
        ...
        <div className="consent-form container" style={{ maxWidth: '800px', margin: '0 auto', padding: '20px' }}>
            ...
            <div style={{ marginBottom: '30px' }}>
                ...
                <p style={{ marginBottom: '20px' }}>
                    If you have any questions or concerns, please contact our Science Fair Designated Supervisor Jacob Hunter at <a href="mailto:jacob.hunter@north-scott.k12.ia.us">jacob.hunter@north-scott.k12.ia.us</a>.
                </p>
            </div>
